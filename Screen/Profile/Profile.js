...
function Profile({ navigation }) {
    ...
    const [modalVisible, setModalVisible, isVisible] = useState(false);
                                        ...
                                        <View style={STYLE.Style.card5}>
                                            <Text
                                                style={{
                                                    ...
                                                    color: COLOR.BLACK, margin: 10, marginLeft: 35
                                                }}>Cancel</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity >
                ...
                <View style={STYLE.Style.card2}>
                    <View style={{ margin: 20, marginTop: 30 }}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 15 }}>
                            ...
                            <View style={{ flexDirection: "row", }}>
                                <TouchableOpacity onPress={() => navigation.navigate('Invite_friend')}>
                                    <Feather name="chevron-right" size={24} style={{ color: "#B9B9B9" }} />
                                </TouchableOpacity>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 15 }}>
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <Text style={STYLE.Style.text1}>{"Suport"}</Text>
                            </View>
                            <View style={{ flexDirection: "row", }}>
                                <TouchableOpacity onPress={() => navigation.navigate('Suport')}>
                                    <Feather name="chevron-right" size={24} style={{ color: "#B9B9B9" }} />
                                </TouchableOpacity>
                            </View>
                        </View>
